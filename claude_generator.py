...
def analyze_codebase():
    ...
    key_files = ['foundry.toml', 'remappings.txt', '.gitmodules']
...
def generate_code_with_claude(task_description, codebase_context):
    ...
    prompt = f"""
You are an expert blockchain developer working on a Foundry-based Solidity smart contract project focused on Filecoin onramp functionality for writing data to the Filecoin network.
...
- Use Solidity best practices and follow the existing code style
- Leverage OpenZeppelin contracts where appropriate
- Include proper error handling and validation
- Add comprehensive NatSpec documentation
- Consider gas optimization
- Use existing imports and dependencies from the lib/ directory
- Follow the project's existing patterns for Filecoin integration
- Include relevant tests if creating new contracts
